 ...
 *
 * Hand-written -- see Status.h for provenance/verification notes.
 */
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    // void1 padding
    canardEncodeScalar(msg_buf, offset, 1, (void*)&void_pad);
    offset += 1;
  ...
  int32_t offset)
{
    ...
    // void1 padding
    ret = canardDecodeScalar(transfer, (uint32_t)offset, 1, false, (void*)&void_pad);
    if (ret != 1)
    {
        goto uavcan_equipment_actuator_Status_error_exit;
    }
