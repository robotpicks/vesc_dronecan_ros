 ...
 * in the environment this was authored in. The 64-bit DSDL signature below
 * was cross-checked against python-dronecan's own computed signature for
 * this type (dronecan.uavcan.equipment.actuator.ArrayCommand._data_type_signature
 * == 0xd8a7486238ec3af3), and the tail-array (no length prefix) framing was
 * verified empirically by round-tripping through python-dronecan's encoder.
 *
...
#define UAVCAN_EQUIPMENT_ACTUATOR_ARRAYCOMMAND_MAX_SIZE           ((480 + 7)/8)
...
typedef struct
{
    ...
    struct
    {
        ...
        uavcan_equipment_actuator_Command*  data;    // Dynamic Array Command[15] max items
    } commands;
